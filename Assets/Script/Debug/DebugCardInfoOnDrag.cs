...
public class DebugCardInfoOnDrag : MonoBehaviour
{
    private static DebugCardInfoOnDrag _instance;
    public static DebugCardInfoOnDrag instance {
        get {
            if (_instance == null) {
                _instance = (DebugCardInfoOnDrag)FindObjectOfType(typeof(DebugCardInfoOnDrag));
                if (_instance == null) {
