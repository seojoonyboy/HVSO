...
namespace UnityEngine.UI.Extensions {
    ...
    public class HssScrollConflictManager : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
        ...
        public void OnBeginDrag(PointerEventData eventData) {
            ...
            if (scrollOtherHorizontally) {
                if (horizontal > vertical) {
                    ...
                    ParentScrollRect.gameObject.GetComponent<HorizontalScrollSnap>().OnBeginDrag(eventData);
                }
            }
        ...
        public void OnDrag(PointerEventData eventData) {
            if (scrollOther) {
                ...
                ParentScrollRect.gameObject.GetComponent<HorizontalScrollSnap>().OnDrag(eventData);
            }
        }
    }
}